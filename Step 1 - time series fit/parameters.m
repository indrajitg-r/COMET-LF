...
% theta_vh = 0.0632;
% %assumed parameters
% omega_E = 0.1614; %assumed 
% lambda_E = 0.6810; % n*psi_2/time
% omega_W = 0.7085; % probality that a person has only male or only 
% %                 % female adult worms taking total worm number is 5
% lambda_W = 0.1715; % probality that a person has atleat one male and one 
